...
do--[[utility]]--
	...
	e2function void dcheckbox:create(array players)
	...
	e2function void dcheckbox:modify(array players)
		E2VguiCore.ModifyPanel(self,this,players)
	end

	e2function void dcheckbox:modify(n updateChildsToo)
		E2VguiCore.ModifyPanel(self, this, nil, updateChildsToo > 0)
	end

	e2function void dcheckbox:modify(n updateChildsToo,array players)
