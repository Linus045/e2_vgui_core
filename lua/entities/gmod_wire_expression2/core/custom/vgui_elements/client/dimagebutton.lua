...
E2Helper.Descriptions["setNoClipping(xib:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xib:e)"] = "Gets whether the element is clipped by its ancestors or not."
