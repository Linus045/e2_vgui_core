...
E2Helper.Descriptions["setNoClipping(xib:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xib:e)"] = "Gets whether the element clips its children or not."
