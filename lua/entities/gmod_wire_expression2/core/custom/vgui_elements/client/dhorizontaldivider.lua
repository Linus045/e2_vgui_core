...
E2Helper.Descriptions["setRight(xdg:n)"] = "Sets the right side content of the HorizontalDivider."
E2Helper.Descriptions["setDividerWidth(xdg:n)"] = "Sets the width of the horizontal divider bar."
E2Helper.Descriptions["setLeftMin(xdg:n)"] = "Sets the minimum width of the left side"
E2Helper.Descriptions["setRightMin(xdg:n)"] = "Sets the minimum width of the right side"
E2Helper.Descriptions["setLeftWidth(xdg:n)"] = "Sets the current/starting width of the left side. The width of the right side is automatically calculated by subtracting this from the total width of the HorizontalDivider."
E2Helper.Descriptions["setAutoSize(xdg:n)"] = "A value between 0-1. Dynamically resizes the sides to match the given ratio. Use -1 to disable autosizing again. E.g. 0.5 means both sides will occupy half of the total width."
E2Helper.Descriptions["getDragging(xdg:n)"] = "Whether or not dragging of the divider is allowed."
E2Helper.Descriptions["getLeft(xdg:e)"] = "Returns the left panel id"
E2Helper.Descriptions["getRight(xdg:e)"] = "Returns the right panel id"
E2Helper.Descriptions["getDividerWidth(xdg:e)"] = "Returns the width of the divider"
E2Helper.Descriptions["getLeftMin(xdg:e)"] = "Gets the minimum width of the left side"
E2Helper.Descriptions["getRightMin(xdg:e)"] = "Gets the minimum width of the right side"
E2Helper.Descriptions["getLeftWidth(xdg:e)"] = "Gets the current/starting width of the left side. Does not work when AutoSize is used."
E2Helper.Descriptions["getAutoSize(xdg:e)"] = "Whether or not autosize is used."
