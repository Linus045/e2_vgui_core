...
E2Helper.Descriptions["setNoClipping(xdb:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xdb:e)"] = "Gets whether the element is clipped by its ancestors or not."
