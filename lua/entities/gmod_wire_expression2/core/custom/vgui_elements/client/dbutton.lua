...
E2Helper.Descriptions["setNoClipping(xdb:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xdb:e)"] = "Gets whether the element clips its children or not."
