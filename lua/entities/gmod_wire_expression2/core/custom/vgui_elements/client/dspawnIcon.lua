...
E2Helper.Descriptions["setNoClipping(xdi:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xdi:e)"] = "Gets whether the element is clipped by its ancestors or not."
