...
E2Helper.Descriptions["setNoClipping(xds:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xds:e)"] = "Gets whether the element clips its children or not."
