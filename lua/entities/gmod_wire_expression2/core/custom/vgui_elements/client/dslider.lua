...
E2Helper.Descriptions["center(xds:)"] = "Centers the panel in the middle of the screen."
...
E2Helper.Descriptions["getMin(xds:)"] = "Returns the minimum Value."
E2Helper.Descriptions["getMax(xds:)"] = "Returns the maximum Value."
...
E2Helper.Descriptions["getValue(xds:)"] = "Gets the curren Slider Value."
