...
E2Helper.Descriptions["stretchToParent(xde:nnnn)"] = "Sets the dimensions of the panel to fill its parent. Use -1 to disable stretching in direction. Use 0 for no offset or define a value greater than 0 to set an offset in that direction."
