...
E2Helper.Descriptions["setNoClipping(xde:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xde:e)"] = "Gets whether the element clips its children or not."
