...
E2Helper.Descriptions["setNoClipping(xde:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xde:e)"] = "Gets whether the element is clipped by its ancestors or not."
