...
E2Helper.Descriptions["setNoClipping(xdl:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xdl:e)"] = "Gets whether the element clips its children or not."
