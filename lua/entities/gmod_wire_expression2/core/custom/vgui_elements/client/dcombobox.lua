...
E2Helper.Descriptions["setNoClipping(xcb:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xcb:e)"] = "Gets whether the element clips its children or not."
