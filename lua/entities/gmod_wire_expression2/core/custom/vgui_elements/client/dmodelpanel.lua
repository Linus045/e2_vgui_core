...
E2Helper.Descriptions["setNoClipping(xdk:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xdk:e)"] = "Gets whether the element is clipped by its ancestors or not."
