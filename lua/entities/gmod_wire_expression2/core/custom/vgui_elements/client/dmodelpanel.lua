...
E2Helper.Descriptions["setNoClipping(xdk:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xdk:e)"] = "Gets whether the element clips its children or not."
