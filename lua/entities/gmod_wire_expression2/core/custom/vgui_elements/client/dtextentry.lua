...
E2Helper.Descriptions["setNoClipping(xdt:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xdt:e)"] = "Gets whether the element is clipped by its ancestors or not."
