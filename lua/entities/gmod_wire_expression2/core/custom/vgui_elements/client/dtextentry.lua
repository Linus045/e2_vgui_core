...
E2Helper.Descriptions["setNoClipping(xdt:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xdt:e)"] = "Gets whether the element clips its children or not."
