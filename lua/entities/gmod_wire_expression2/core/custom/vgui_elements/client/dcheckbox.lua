...
E2Helper.Descriptions["setNoClipping(xdc:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xdc:e)"] = "Gets whether the element is clipped by its ancestors or not."
