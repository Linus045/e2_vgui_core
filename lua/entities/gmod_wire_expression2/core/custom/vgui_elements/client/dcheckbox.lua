...
E2Helper.Descriptions["setNoClipping(xdc:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xdc:e)"] = "Gets whether the element clips its children or not."
