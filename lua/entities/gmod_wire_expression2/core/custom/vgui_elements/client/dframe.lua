...
E2Helper.Descriptions["setNoClipping(xdf:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xdf:e)"] = "Gets whether the element clips its children or not."
