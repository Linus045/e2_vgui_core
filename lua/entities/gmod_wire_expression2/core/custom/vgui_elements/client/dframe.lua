...
E2Helper.Descriptions["setNoClipping(xdf:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xdf:e)"] = "Gets whether the element is clipped by its ancestors or not."
