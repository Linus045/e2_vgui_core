...
E2Helper.Descriptions["setNoClipping(xdl:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xdl:e)"] = "Gets whether the element is clipped by its ancestors or not."
