...
E2Helper.Descriptions["setNoClipping(xdv:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xdv:e)"] = "Gets whether the element clips its children or not."
