...
E2Helper.Descriptions["setNoClipping(xdv:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xdv:e)"] = "Gets whether the element is clipped by its ancestors or not."
