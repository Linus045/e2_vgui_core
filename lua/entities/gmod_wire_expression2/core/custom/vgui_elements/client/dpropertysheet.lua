...
E2Helper.Descriptions["stretchToParent(xdo:nnnn)"] = "Sets the dimensions of the panel to fill its parent. Use -1 to disable stretching in direction. Use 0 for no offset or define a value greater than 0 to set an offset in that direction."
...
E2Helper.Descriptions["id(xdo:)"] = "Returns the panel's id that was assigned on creation. Returns 0 if panel is invalid (create() was not yet called)."
...
E2Helper.Descriptions["alignTop(xdo:n)"] = "Aligns the panel with the specified offset to it's parent (or screen if it has no parent)."
E2Helper.Descriptions["alignBottom(xdo:n)"] = "Aligns the panel with the specified offset to it's parent (or screen if it has no parent)."
E2Helper.Descriptions["alignLeft(xdo:n)"] = "Aligns the panel with the specified offset to it's parent (or screen if it has no parent)."
E2Helper.Descriptions["alignRight(xdo:n)"] = "Aligns the panel with the specified offset to it's parent (or screen if it has no parent)."
