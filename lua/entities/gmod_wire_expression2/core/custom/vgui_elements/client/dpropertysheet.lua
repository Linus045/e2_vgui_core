...
E2Helper.Descriptions["setNoClipping(xdo:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xdo:e)"] = "Gets whether the element is clipped by its ancestors or not."
