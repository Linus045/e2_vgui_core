...
E2Helper.Descriptions["setNoClipping(xdo:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xdo:e)"] = "Gets whether the element clips its children or not."
