...
E2Helper.Descriptions["setNoClipping(xdp:n)"] = "Sets whether the element clips its children or not."
E2Helper.Descriptions["getNoClipping(xdp:e)"] = "Gets whether the element clips its children or not."
