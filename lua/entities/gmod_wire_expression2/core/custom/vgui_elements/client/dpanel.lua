...
E2Helper.Descriptions["setNoClipping(xdp:n)"] = "Sets whether the element is clipped by its ancestors or not."
E2Helper.Descriptions["getNoClipping(xdp:e)"] = "Gets whether the element is clipped by its ancestors or not."
